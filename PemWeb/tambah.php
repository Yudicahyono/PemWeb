...
<head>
    ...
    <title>Tambah Data | Sistem Data Siswa | SMA NEGERI 1 PURWODADI</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">Sistem Data Siswa | SMA NEGERI 1 PURWODADI</a>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select w-50" id="jurusan" name="jurusan">
                            <option disabled selected value><b> -- Pilih Jurusan -- </b></option>
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created by <a target="_blank" style="color: #fff;">Yudi Cahyono</a></p>
    </footer>
    <!-- Close Footer -->
